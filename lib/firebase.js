...
const database = getDatabase(app, 'https://app-chat-e3201-default-rtdb.asia-southeast1.firebasedatabase.app');
...
console.log("Database URL:", 'https://app-chat-e3201-default-rtdb.asia-southeast1.firebasedatabase.app/');
